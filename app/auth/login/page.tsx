  ...
  return (
    <div className="min-h-screen bg-forge-surface flex items-center justify-center p-4">
        ...
        <div className="inline-flex items-center gap-3 mb-4">
            ...
            <img src="/Forge-Logo.png" alt="FORGË" className="w-7 h-7 object-contain" />
          </div>
            <div className="text-left">
              <div className="text-2xl font-bold text-forge-text-primary">FORG<span className="text-forge-gold">Ë</span></div>
        ...
        <div className="forge-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? <><Loader2 className="w-4 h-4 animate-spin" /> Signing in…</> : 'Sign In to FORGË'}
            </button>
          </form>
          <p className="mt-4 text-center text-xs text-forge-text-muted">coach@dfitfactor.com / coach-2025</p>
        </div>
      </div>
    </div>
  )
